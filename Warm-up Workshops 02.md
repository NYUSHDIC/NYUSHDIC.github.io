---
title: "2025-09-25 · Digital Innovation Challenge 2025 · Idea-to-App with base44"
permalink: /Warm-up Workshops 02/
layout: single
classes: wide
---
...
Vibe Coding 由 Andrej Karpathy 提出，指的是借助人工智能，通过自然语言进行编程。你无需逐行写代码，只需描述自己的想法，大语言模型就会生成并优化代码。这种方式遵循“先产出代码，再精细调整”的路径，使编程更直观、更易上手。  
...
传统编程强调精确、逻辑结构以及对性能的全面掌控。相比之下，Vibe Coding 更加对话化，也更“放手”——人们专注于创意，而 AI 负责实现。这让它特别适合快速原型、创意项目和早期探索。  
...
Vibe Coding 让初学者与专家都能以极快的速度把想法变为现实。它降低了门槛，使编程更具趣味性、协作性和普及性。GitHub Copilot、Claude、Codex 等工具正推动着“意图即软件”的未来。  
...
2. **Prompt 撰写 Prompt Writing**  
   将设计思路转化为简明文字指令，引导 AI 生成符合预期的布局和内容。  
   Translate design concepts into concise textual instructions to guide AI in producing the desired layout and content.  

3. **AI 生成与迭代 AI Generation & Iteration**  
   将 Prompt 导入 Base44，生成原型后，根据结果不断调整和完善界面、分类和交互，实现最终产品落地。  
